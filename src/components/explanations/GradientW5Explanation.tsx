  ...
  return (
    <div className="space-y-4">
      ...
      <p>
        ...
        "the partial derivative of <KatexComponent formula="E_{total}" /> with respect to <KatexComponent formula="w_5" />". 
        You can also say "the gradient with respect to <KatexComponent formula="w_5" />". This tells us how 
